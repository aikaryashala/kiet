...
Published at https://aikaryashala.com/kiet/bootcamp-03/. The material students use on the day lives in the
...
| `setup.html` | The setup steps, written out. Generated by `build/hub.py`. |
...
`build/` holds the Python scripts that produced the material pages in `kiet-bootcamp-3/docs/` and `setup.html`
